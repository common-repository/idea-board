...
class WpQuerySearch {
	...
	public function where( $where ) {
		...
		$this->searchType  = $this->search[ 'type' ] ? $this->search[ 'type' ] : Request::get_parameter( 'searchType' );
		$this->searchValue = $this->search[ 'value' ] ? $this->search[ 'value' ] : Request::get_parameter( 'searchValue' );
