...
class GlobalSetting {
	...
	public static function get_use_permalink_struct() {
		return AdminGlobalAction::instance()->setting->get_option( 'idea_board_use_permalink_struct', PluginConfig::$permalink_structure ? true : false );
	}
}