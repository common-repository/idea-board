...
class Plugin {
	...
	/**
	 * @var PostHierarchyOrderGenerator
	 */
	...
	public function plugin_hooks() {
		...
		$link = new Link();
		$this->loader->add_filter( 'post_type_link', $link, 'post_type_link', 10, 2 );
		...
		add_shortcode( 'idea_board', array( $short_code, 'idea_board' ) );
		...
		$this->loader->add_action( 'admin_menu', $dash_board, 'admin_menu', 0 );
		$this->loader->add_filter( 'custom_menu_order', $dash_board, 'menu_sort_change' );
	...
	public function register_global() {
		$this->post_order_generator = new PostHierarchyOrderGenerator( PluginConfig::$board_post_type, 'idea_board_grp', 'idea_board_ord', 'idea_board_depth' );
